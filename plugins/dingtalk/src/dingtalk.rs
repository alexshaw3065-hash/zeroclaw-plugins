//! Pure DingTalk source-only channel migration logic.
//!
...
//! DingTalk channel is fully ported into a publishable plugin.

use serde::Deserialize;
use serde_json::Value;

pub const CHANNEL: &str = "dingtalk";
pub const PLUGIN_NAME: &str = "dingtalk";
pub const HOST_GATE: &str = "DingTalk robot send/webhook parity is source-only until the host webhook-ingress path is released for plugins.";
