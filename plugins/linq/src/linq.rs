//! Pure Linq source-only channel migration logic.
//!
...
//! Linq channel is fully ported into a publishable plugin.

use serde::Deserialize;
use serde_json::Value;

pub const CHANNEL: &str = "linq";
pub const PLUGIN_NAME: &str = "linq";
pub const HOST_GATE: &str = "Linq requires a host-managed Linq client or a future WASI TCP/TLS capability before this source-only plugin can publish.";
