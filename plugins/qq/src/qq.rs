//! Pure QQ Official source-only channel migration logic.
//!
...
//! QQ Official channel is fully ported into a publishable plugin.

use serde::Deserialize;
use serde_json::Value;

pub const CHANNEL: &str = "qq";
pub const PLUGIN_NAME: &str = "qq";
pub const HOST_GATE: &str = "QQ webhook/send parity is source-only until the host webhook-ingress path is released for plugins.";
