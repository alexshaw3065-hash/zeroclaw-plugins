//! Pure Matrix source-only channel migration logic.
//!
...
//! Matrix channel is fully ported into a publishable plugin.

use serde::Deserialize;
use serde_json::Value;

pub const CHANNEL: &str = "matrix";
pub const PLUGIN_NAME: &str = "matrix";
pub const HOST_GATE: &str = "Matrix sync, crypto/session storage, and send semantics require a dedicated plugin port before this source-only plugin can publish.";
