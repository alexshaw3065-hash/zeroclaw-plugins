//! Pure Signal source-only channel migration logic.
//!
...
//! Signal channel is fully ported into a publishable plugin.
...
pub const HOST_GATE: &str = "Signal depends on the host-managed signal-cli/native service boundary before this source-only plugin can publish.";
