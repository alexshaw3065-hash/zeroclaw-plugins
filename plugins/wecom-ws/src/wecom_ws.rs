//! Pure WeCom WebSocket source-only channel migration logic.
//!
...
//! WeCom WebSocket channel is fully ported into a publishable plugin.
...
pub const HOST_GATE: &str = "WeCom WebSocket requires the host `websocket_client` capability and protocol port before this source-only plugin can publish.";
