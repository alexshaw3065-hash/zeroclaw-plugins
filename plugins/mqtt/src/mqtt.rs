//! Pure MQTT source-only channel migration logic.
//!
...
//! MQTT channel is fully ported into a publishable plugin.
...
pub const HOST_GATE: &str = "MQTT requires host-managed broker connectivity or a future WASI TCP/TLS capability before this source-only plugin can publish.";
