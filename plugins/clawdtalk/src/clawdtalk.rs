//! Pure ClawdTalk source-only channel migration logic.
//!
...
//! ClawdTalk channel is fully ported into a publishable plugin.

use serde::Deserialize;
use serde_json::Value;

pub const CHANNEL: &str = "clawdtalk";
pub const PLUGIN_NAME: &str = "clawdtalk";
pub const HOST_GATE: &str = "ClawdTalk protocol I/O remains host-gated until the native transport is exposed to channel plugins.";
