//! Pure Email source-only channel migration logic.
//!
...
//! Email channel is fully ported into a publishable plugin.
...
pub const HOST_GATE: &str = "Email requires host-managed IMAP/SMTP/TLS or a future socket/mail capability before this source-only plugin can publish.";
