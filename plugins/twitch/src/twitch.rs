//! Pure Twitch source-only channel migration logic.
//!
...
//! Twitch channel is fully ported into a publishable plugin.
...
pub const HOST_GATE: &str = "Twitch chat requires host-managed IRC/TLS socket support before this source-only plugin can publish.";
