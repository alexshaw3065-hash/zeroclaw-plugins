//! Pure AMQP source-only channel migration logic.
//!
...
//! AMQP channel is fully ported into a publishable plugin.
...
pub const HOST_GATE: &str = "AMQP requires a host-managed AMQP client or a future WASI TCP/TLS capability before this source-only plugin can publish.";
